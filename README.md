...
## Environments
- Preview: https://main--forms-edge-delivery-demo2--akshayvas.hlx.page/
- Live: https://main--forms-edge-delivery-demo2--akshayvas.hlx.live/
...
1. Open the `forms-edge-delivery-demo2` directory in your favorite IDE and start coding :)
